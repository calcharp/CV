...
%-------------------------------------------------------------------------------
\name{Caleb Charpentier}{}
\position{PhD Student{\enskip\cdotp\enskip}Biological Sciences}
\address{Virginia Tech, 926 W Campus Dr, Blacksburg, VA 24060}

\email{calebc22@vt.edu}
...
\makecvfooter
  {\date{}}
  {Caleb Charpentier ~~~·~~~ Curriculum Vitae}
  {\thepage}
